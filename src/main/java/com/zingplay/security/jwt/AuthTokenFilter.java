package com.zingplay.security.jwt;
    ...
    try {
      ...
      if (jwt != null && jwtUtils.validateJwtToken(jwt)) {
        String username = jwtUtils.getUserNameFromJwtToken(jwt);
          ...
          String game = getGame(request);
          String country = getCountry(request);
          MultiTenantMongoDbFactory.setDatabaseNameForCurrentThread(game,country);
          UserDetailsImpl userDetails = new UserDetailsImpl(username,username,game,country,authorities);
